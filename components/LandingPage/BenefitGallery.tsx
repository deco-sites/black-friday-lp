...
export default function BenefitGallery({title, content, benefitButtons, placeHolderImage, backgroundColor, textColor}: Props) {
  return (
      ...
      <div className="flex justify-between">
        <div className="flex-col gap-4">
          {benefitButtons.map(({icon, text, image}: BenefitButton) => (
            <div className="flex gap-4 p-4 shadow-md rounded justify-between">
              <Image 
                height={23}
                width={23}
                src={icon}
